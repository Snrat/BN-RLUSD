...
BYBIT_KNOWN_EXTRA_APR = {
    ...
    "2026-08-27": 0.0299,  # 合计 6.49% = 基础 3.5% + 额外 2.99%
    "2026-08-28": 0.027,   # 合计 6.20% = 基础 3.5% + 额外 2.70%
    "2026-08-29": 0.026,   # 合计 6.10% = 基础 3.5% + 额外 2.60%
    "2026-08-30": 0.0256,  # 合计 6.06% = 基础 3.5% + 额外 2.56%
}
